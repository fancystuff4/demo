 ...
 */
export var getUpdatePackageInfo = function getUpdatePackageInfo(initialPackageInfo, _ref) {
  ...
  packageInfo.files = [resolve(outputPath).replace("".concat(process.cwd(), "/"), '')]; // Overwrite license to MIT
