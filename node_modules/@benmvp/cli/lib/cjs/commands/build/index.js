...
var _runBabel = _interopRequireDefault(require("./run-babel"));

var _args5 = require("../../cli/args");
...
var genTranspiledFiles = function genTranspiledFiles(buildArgs) {
  ...
  return _regenerator.default.async(function genTranspiledFiles$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          babelArgsToRun = (0, _utils.getBabelCLIOptionsList)(buildArgs);
        ...
        case 6:
          ...
          _context.next = 10;
          return _regenerator.default.awrap((0, _runBabel.default)(babelArgs));
...
var genTypedFiles = function genTypedFiles(buildArgs) {
  ...
  return _regenerator.default.async(function genTypedFiles$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          typeScriptArgsToRun = (0, _utils.getTypescriptArgs)(buildArgs);
          ...
          _context2.next = 6;
          return _regenerator.default.awrap(execAsync(command));
...
var deleteUnneededFiles = function deleteUnneededFiles(outDir) {
  return _regenerator.default.async(function deleteUnneededFiles$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _regenerator.default.awrap(execAsync("npx rimraf ".concat((0, _utils.getCopiedFilesToDelete)(outDir).join(' '))));
  ...
  return _regenerator.default.async(function _callee$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _ref = _args4.length > 0 && _args4[0] !== undefined ? _args4[0] : {}, _ref$formats = _ref.formats, formats = _ref$formats === void 0 ? _args5.BUILD_ARGS.formats.default : _ref$formats, _ref$out = _ref.out, out = _ref$out === void 0 ? _args5.BUILD_ARGS.out.default : _ref$out, _ref$watch = _ref.watch, watch = _ref$watch === void 0 ? _args5.BUILD_ARGS.watch.default : _ref$watch;
          _context4.prev = 1;
          uniqueFormats = new Set(formats);
          outDir = out || (0, _path.resolve)(process.cwd(), 'lib');
          buildOptions = {
          ...
          _context4.next = 8;
          return _regenerator.default.awrap(genTranspiledFiles(buildOptions));

        case 8:
          _context4.next = 10;
          return _regenerator.default.awrap(genTypedFiles(buildOptions));

        case 10:
          _context4.next = 12;
          return _regenerator.default.awrap(deleteUnneededFiles(outDir));
