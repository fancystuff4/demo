...
exports.getJestArgs = exports.VALID_TEST_MODES = void 0;
...
var VALID_TEST_MODES = {
  type: (0, _path.resolve)(__dirname, 'project-type.js'),
  lint: (0, _path.resolve)(__dirname, 'project-lint.js'),
  spec: (0, _path.resolve)(__dirname, 'project-spec.js')
};
/**
...
exports.VALID_TEST_MODES = VALID_TEST_MODES;

var getJestArgs = function getJestArgs(_ref) {
...
exports.getJestArgs = getJestArgs;